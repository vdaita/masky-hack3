This project is based on github.com/ultralytics/yolov5.
The data for this project is from https://github.com/archie9211/Mask-Detection-Dataset
The model was trained on Google Colab.
Run python3 detect.py --weights weights/mask.pt --source 0 for webcam.
Made for Hack3 Hackathon.
